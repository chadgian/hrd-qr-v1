  ...
  <div class="offcanvas offcanvas-end" tabindex="-1" id="sidebar" aria-labelledby="sidebarLabel">
    ...
    <div class="offcanvas-body">
      <div class="accordion" id="sidebarAccordion">
        <div class="accordion-item">
          <h2 class="accordion-header">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#addParticipant" aria-expanded="false" aria-controls="addParticipant">
          ...
          <div id="addParticipant" class="accordion-collapse collapse" data-bs-parent="#sidebarAccordion">
            <div class="accordion-body">
              <p class="text-muted">Upload an excel file that contains the data of participants. The first column should contain the participant's number, followed by last name, first name, middle initial, and agency. <i>The saving of data will start at 2nd row of the excel.</i></p>
              <form action="../processes/exportExcel.php" method="post" enctype="multipart/form-data" class="d-flex flex-column gap-3 justify-content-center align-items-center">
        ...
        <div class="accordion-item">
          ...
          <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#sidebarAccordion">
            <div class="accordion-body">
              <form action="../processes/editParticipant.php" method='post' class="d-flex flex-column align-items-center justify-content-center">
                ...
                <div class="input-group mb-3">
                  ...
                  <input type="text" name="middle_initial" id="middle_initial" class="form-control" placeholder="e.g. G.">
                </div>
                <div class="input-group mb-3">
        ...
        <div class="accordion-item">
          ...
          <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#sidebarAccordion">
            <div class="accordion-body">
              <form action="../processes/generateIDProcess.php" method="POST" class="d-flex flex-column align-items-center justify-content-center">
                ...
                <div class="input-group mb-3">
                  ...
                  <input type="text" name="trainingName" id="trainingName" class="form-control" placeholder="e.g. ePRIMEtime" required>
                </div>
                <div class="input-group mb-3">
                  <label for="trainingDate" class="input-group-text">Training Days:</label>
                  <input type="text" name="trainingDate" id="trainingDate" class="form-control" placeholder="e.g. April 4-5, 2024" required>
                </div>
                <div class="input-group mb-3">
                  <label for="trainingVenue" class="input-group-text">Training Venue:</label>
                  <input type="text" name="trainingVenue" id="trainingVenue" class="form-control" placeholder="e.g. Grand Xing Imperial Hotel, Iloilo City" required>
                </div>
                <input type="submit" value="Generate" id="submit-button" style="display: block;" class="btn btn-secondary">
              </form>
        ...
        <div class="accordion-item">
          <h2 class="accordion-header">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-card-checklist me-2" viewBox="0 0 16 16">
        ...
        <div class="accordion-item">
          <h2 class="accordion-header">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-qr-code-scan me-2" viewBox="0 0 16 16">
        ...
        <div class="accordion-item">
          <h2 class="accordion-header">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-card-list me-2" viewBox="0 0 16 16">
              <path d="M14.5 3a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5h-13a.5.5 0 0 1-.5-.5v-9a.5.5 0 0 1 .5-.5zm-13-1A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h13a1.5 1.5 0 0 0 1.5-1.5v-9A1.5 1.5 0 0 0 14.5 2z"/>
          ...
          <div id="collapseSix" class="accordion-collapse collapse" data-bs-parent="#sidebarAccordion">
            <div class="accordion-body d-flex justify-content-around align-items-start gap-2">
              <form action="../processes/editAttendance.php" method='post' class="d-flex flex-column align-items-center justify-content-center">
                <div class="input-group mb-3">
      ...
      <div class="d-flex flex-column justify-content-center align-items-center bottom my-3">
        ...
        <a href="../processes/exportAttendance.php?id=<?php echo $trainingID; ?>" class='text-dark my-3'>Export Attendance</a>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                ...
                <button type="button" class="btn btn-danger"><a href="../processes/deleteTraining.php?id=<?php echo $trainingID; ?>" class="text-light" style="text-decoration: none;">DELETE</a></button>
              </div>
            </div>
          </div>
        </div>
