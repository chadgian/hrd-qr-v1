  ...
  <div class="container text-center px-lg-5">
    ...
    <form action="../processes/addTrainingProcess.php" method="post" class="my-5">
      <div class="input-group mb-3">
        ...
        <input type="text" name="training-name" id="training-name" placeholder="Training Name" class="form-control"
          required>
      </div>
      <div class="input-group mb-3">
        <label for="training-month" class="input-group-text">Month:</label>
        <input type="text" name="training-month" id="training-month" placeholder="January" class="form-control"
          required><br>
      </div>
      <div class="input-group mb-3">
        <label for="training-year" class="input-group-text">Year:</label>
        <input type="number" name="training-year" id="training-year" placeholder="2024" class="form-control"
          required><br>
      </div>
      <div class="input-group mb-3">
